...
// This component is the last chance a user will get to edit all the information they input prior to the order being send to the admin
//  It allows the user to update/ delete events, edit contact and order information.
    ...
    <div className="invoice-container">
      ...
      >
        ...
        >
          ...
          <Paper
            elevation={12}
            style={{ width: "90%", marginLeft: "5rem", marginRight: "1rem" }}
          >
